...
namespace JVermeulen.WebSockets
{
    public class WsSession2 : Actor
    {
        ...
        public WsSession2(ITcpEncoder<WsContent> encoder, bool isServer, string serverUrl, WebSocket socket) : base(TimeSpan.FromSeconds(60))
        {
